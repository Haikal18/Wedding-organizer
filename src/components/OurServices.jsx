        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden text-center p-8">
            <div className="flex justify-center mb-6">
              <FontAwesomeIcon icon={faCamera} className="text-pink-600 w-16 h-16"/>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden text-center p-8">
            <div className="flex justify-center mb-6">
              <FontAwesomeIcon icon={faHeart} className="text-pink-600 w-16 h-16"/>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden text-center p-8">
            <div className="flex justify-center mb-6">
              <FontAwesomeIcon icon={faUtensils} className="text-pink-600 w-16 h-16"/>
            </div>
