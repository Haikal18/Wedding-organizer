...
function MembershipPlan() {
  return (
    <section  className="bg-[#F1F1F1] pt-11 pb-5">
      <div id="Pricing"  className="container mx-auto px-4 pt-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center p-6">
            <div className="bg-[#FFDE4D] py-4 text-white font-semibold text-xl">Basic</div>
            <div className="py-6">
            ...
            <a href="#" className="inline-block bg-[#FFDE4D] text-white font-bold py-2 px-6 rounded-full hover:bg-red-600 transition">Buy Now</a>
          </div>

          {/* Plan 2: Standard */}
          <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center p-6">
            <div className="bg-[#FFDE4D] py-4 text-white font-semibold text-xl">Standard</div>
            <div className="py-6">
          ...
          {/* Plan 3: Premium */}
          <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center p-6">
            <div className="bg-[#FFDE4D] py-4 text-white font-semibold text-xl">Premium</div>
            <div className="py-6">
